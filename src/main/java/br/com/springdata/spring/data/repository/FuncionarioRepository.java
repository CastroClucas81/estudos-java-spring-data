package br.com.springdata.spring.data.repository;
...
@Repository
//JPA SPECIFICATION... é para fazer querys dinamicas
public interface FuncionarioRepository extends
	...
	@Query("SELECT " +
			...
			"WHERE " +
				"f.nome = :nome AND " +
				"f.salario >= :salario AND " +
				"f.dataContratacao = :data")
	List<Funcionario> findNomeSalarioMaiorDataContratacao(String nome, Double salario, LocalDate data);

	//fazendo com query nativa
